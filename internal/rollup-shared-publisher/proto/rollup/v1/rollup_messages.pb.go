...
type CrossChainTxResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	XtId          *XtID                  `protobuf:"bytes,1,opt,name=xt_id,json=xtId,proto3" json:"xt_id,omitempty"`                         // Transaction ID this result belongs to
	ChainId       []byte                 `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`                // Chain that processed the transaction
	OriginalHash  []byte                 `protobuf:"bytes,3,opt,name=original_hash,json=originalHash,proto3" json:"original_hash,omitempty"` // Original transaction hash submitted (32 bytes)
	FinalHash     []byte                 `protobuf:"bytes,4,opt,name=final_hash,json=finalHash,proto3" json:"final_hash,omitempty"`          // Final transaction hash executed (32 bytes, may differ if re-signed)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CrossChainTxResult) Reset() {
	*x = CrossChainTxResult{}
	mi := &file_rollup_messages_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CrossChainTxResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrossChainTxResult) ProtoMessage() {}

func (x *CrossChainTxResult) ProtoReflect() protoreflect.Message {
	mi := &file_rollup_messages_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CrossChainTxResult.ProtoReflect.Descriptor instead.
func (*CrossChainTxResult) Descriptor() ([]byte, []int) {
	return file_rollup_messages_proto_rawDescGZIP(), []int{9}
}

func (x *CrossChainTxResult) GetXtId() *XtID {
	if x != nil {
		return x.XtId
	}
	return nil
...
func (x *CrossChainTxResult) GetChainId() []byte {
	if x != nil {
		return x.ChainId
	}
	return nil
...
func (x *CrossChainTxResult) GetOriginalHash() []byte {
	if x != nil {
...
func (x *CrossChainTxResult) GetFinalHash() []byte {
	if x != nil {
		return x.FinalHash
	}
	return nil
...
func (x *Message) GetCrossChainTxResult() *CrossChainTxResult {
	if x != nil {
		if x, ok := x.Payload.(*Message_CrossChainTxResult); ok {
			return x.CrossChainTxResult
		}
	}
	return nil
}
...
type Message_CrossChainTxResult struct {
	// Transaction result communication
	CrossChainTxResult *CrossChainTxResult `protobuf:"bytes,14,opt,name=cross_chain_tx_result,json=crossChainTxResult,proto3,oneof"`
}
...
func (*Message_CrossChainTxResult) isMessage_Payload() {}
...
const file_rollup_messages_proto_rawDesc = "" +
	...
	"\x04data\x18\a \x03(\fR\x04data\"\x99\x01\n" +
	"\x12CrossChainTxResult\x12$\n" +
	"\x05xt_id\x18\x01 \x01(\v2\x0f.rollup.v1.XtIDR\x04xtId\x12\x19\n" +
	"\bchain_id\x18\x02 \x01(\fR\achainId\x12#\n" +
	"\roriginal_hash\x18\x03 \x01(\fR\foriginalHash\x12\x1d\n" +
	"\n" +
	"final_hash\x18\x04 \x01(\fR\tfinalHash\"o\n" +
	...
	"\x05xt_id\x18\x04 \x01(\fR\x04xtId\"\xc6\x06\n" +
	"\aMessage\x12\x1b\n" +
	...
	"\x12handshake_response\x18\r \x01(\v2\x1c.rollup.v1.HandshakeResponseH\x00R\x11handshakeResponse\x12R\n" +
	"\x15cross_chain_tx_result\x18\x0e \x01(\v2\x1d.rollup.v1.CrossChainTxResultH\x00R\x12crossChainTxResultB\t\n" +
...
var file_rollup_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_rollup_messages_proto_goTypes = []any{
	...
	(*CrossChainTxResult)(nil),   // 9: rollup.v1.CrossChainTxResult
	(*L2BlockRequest)(nil),       // 10: rollup.v1.L2BlockRequest
	(*StartSlot)(nil),            // 11: rollup.v1.StartSlot
	(*RequestSeal)(nil),          // 12: rollup.v1.RequestSeal
	(*RollBackAndStartSlot)(nil), // 13: rollup.v1.RollBackAndStartSlot
	(*L2Block)(nil),              // 14: rollup.v1.L2Block
	(*StartSC)(nil),              // 15: rollup.v1.StartSC
	(*Message)(nil),              // 16: rollup.v1.Message
}
var file_rollup_messages_proto_depIdxs = []int32{
	...
	2,  // 5: rollup.v1.CrossChainTxResult.xt_id:type_name -> rollup.v1.XtID
	10, // 6: rollup.v1.StartSlot.l2_blocks_request:type_name -> rollup.v1.L2BlockRequest
	10, // 7: rollup.v1.RollBackAndStartSlot.l2_blocks_request:type_name -> rollup.v1.L2BlockRequest
	3,  // 8: rollup.v1.StartSC.xt_request:type_name -> rollup.v1.XTRequest
	3,  // 9: rollup.v1.Message.xt_request:type_name -> rollup.v1.XTRequest
	5,  // 10: rollup.v1.Message.vote:type_name -> rollup.v1.Vote
	6,  // 11: rollup.v1.Message.decided:type_name -> rollup.v1.Decided
	7,  // 12: rollup.v1.Message.block:type_name -> rollup.v1.Block
	8,  // 13: rollup.v1.Message.circ_message:type_name -> rollup.v1.CIRCMessage
	11, // 14: rollup.v1.Message.start_slot:type_name -> rollup.v1.StartSlot
	12, // 15: rollup.v1.Message.request_seal:type_name -> rollup.v1.RequestSeal
	13, // 16: rollup.v1.Message.roll_back_and_start_slot:type_name -> rollup.v1.RollBackAndStartSlot
	14, // 17: rollup.v1.Message.l2_block:type_name -> rollup.v1.L2Block
	15, // 18: rollup.v1.Message.start_sc:type_name -> rollup.v1.StartSC
	0,  // 19: rollup.v1.Message.handshake_request:type_name -> rollup.v1.HandshakeRequest
	1,  // 20: rollup.v1.Message.handshake_response:type_name -> rollup.v1.HandshakeResponse
	9,  // 21: rollup.v1.Message.cross_chain_tx_result:type_name -> rollup.v1.CrossChainTxResult
...
func file_rollup_messages_proto_init() {
	...
	file_rollup_messages_proto_msgTypes[16].OneofWrappers = []any{
		...
		(*Message_CrossChainTxResult)(nil),
	}
	type x struct{}
